...
const KEYWORD_RULES = {
  ...
  Media:         ['jellyfin', 'plex', 'emby', 'navidrome', 'audiobookshelf', 'komga', 'kavita', 'komf', 'sonarr', 'radarr', 'lidarr', 'prowlarr', 'readarr', 'tautulli', 'overseerr', 'ombi', 'bazarr', 'whisperasr', 'focalpoint', 'audiobook', 'immich', 'photo pris', 'photoprism', 'lychee', 'piwigo', 'tubearchivist', 'jellyseerr'],
  ...
  Dev:           ['gitea', 'gitea-actions', 'forgeo', 'gitlab', 'forgejo', 'git', 'woodpecker', 'drone', 'jenkins', 'teampass', 'hubgit', 'code', 'coder', 'code-server', 'terminal', 'theia', 'kasm', 'docker', 'portainer', 'dockge', 'komodo', 'dokploy', 'kubernetes', 'k9s', 'mkdocs-dev', 'ruffasr', 'cinny-dev', 'coolify', 'uptime-kuma', 'n8n'],
